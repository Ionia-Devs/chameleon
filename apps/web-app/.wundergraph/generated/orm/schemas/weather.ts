...
export interface Query {
	__typename(): "Query";
	getCityById(variables: { config?: ConfigInput; id?: string[] }): ReadonlyArray<City> | null;
	getCityByName(variables: { config?: ConfigInput; country?: string; name: string }): City | null;
}
...
export type Unit = "imperial" | "kelvin" | "metric";
