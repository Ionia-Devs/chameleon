...
var wundergraph_generate_default = (0,
import_sdk.configureWunderGraphGeneration)({
  codeGenerators: [],
...
var wundergraph_operations_default = (0,
import_sdk2.configureWunderGraphOperations)({
  operations: {
    defaultConfig: {
      authentication: {
        required: false,
