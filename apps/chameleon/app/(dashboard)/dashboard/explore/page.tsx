...
export default async function LayoutGridDemo() {
  const cards = [
    ...
    },
    {
      ...
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?lunchable',
    },
    {
      id: 9,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
    ...
    },
    {
      ...
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?league',
    },
    {
      id: 11,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?carnival',
    },
    {
      id: 12,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?halloween',
    },
    {
      id: 13,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?fight',
    },
    {
      id: 14,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
      className: 'md:col-span-2 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?digital',
    },
    {
      id: 15,
      content: <Skeleton title={'OwO'} content={'UwU'}/>,
      className: 'col-span-1 h-80',
      thumbnail:
        'https://source.unsplash.com/random/?gamer',
    },
  ]
